...
contract pool is FT{
    ...
    constructor(address _token1, address _token2) FT("baozetoken","baoze") {
        token1 = _token1;
        token2 = _token2;
    }
 ...
 function getAmount(uint256 Inamount,uint256 Inreserve,uint256 Outreserve) private pure returns (uint256 Outamount) {
    ...
    function increaseliqui(uint amount1, uint amount2, address to) external returns(uint liquid) {
