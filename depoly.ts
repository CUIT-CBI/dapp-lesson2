...
import { Token } from '../typechain/FT'
import { HHLSwapPool } from '../typechain/HHLSwapPool'
import { SignerWithAddress } from '@nomiclabs/hardhat-ethers/signers'

use(solidity)


describe("HHLSwapPool", function() {
  let eth: Token
  let dai: Token
  let pool: HHLSwapPool
  ...
  beforeEach(async () => {
    ...
    const HHLSwapPool = await ethers.getContractFactory("HHLSwapPool")
    pool = await HHLSwapPool.deploy(eth.address, dai.address) as HHLSwapPool
    await pool.deployed()
  })
